...
namespace SnipsSolution.Extensions
{
    public static class EnumerableExtensions
    {
        ...
        public static IEnumerable<TSource[]> Chunk<TSource>(this IEnumerable<TSource> source, int chunkSize)
        {
            ...
            if(chunkSize <= 0) {throw new ArgumentException(nameof(chunkSize), string.Concat(nameof(chunkSize), "must be positive."));}
        ...
        public static bool HasAtLeast<TSource>(this IEnumerable<TSource> source, int minElementCount, Func<TSource, bool> predicate)
        {
            ...
            foreach (TSource unused in source.Where(predicate))
            {
                matches++;
